            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-6 col-sm-12">
                        ...
                        <p class="des margin-bottom-20 text-center">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore
                            et dolore magna aliqua. Ut enim ad minim veniam, quis ullam laboris nisi ut aliquip ex ea commodo
                            consequat.
                        </p>
                ...
                <div class="swin-sc swin-sc-product products-02 carousel-02">
                    ...
                    <div class="products nav-slider">
                        <div class="row slick-padding">
                            <?php foreach($data['allFoods'] as $f):?>
